...
public class CameraController : MonoBehaviour
{
    ...
    //     Vector3 newPosition = new(player.position.x, player.position.y, cam1.position.z);
    //     Vector3 position = Vector3.Lerp(cam1.position, newPosition, Time.fixedDeltaTime * cameraFollowSpeed);
    //     cam1.position = position;
    //     cam2.position = position;
    //     // cam1.position = player.position;
    //     // cam2.position = player.position;
    //     // }
    // }
